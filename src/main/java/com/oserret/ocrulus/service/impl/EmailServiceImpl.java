...
import com.oserret.ocrulus.controller.LoggingController;
import com.oserret.ocrulus.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public void sendEmailUser(Boolean mailSmtpAuth, String mailSmtpSslProtocols, String mailSmtpStarttlsEnable, String mailSmtpHost, String mailSmtpPort,
                          String mailSmtpSslTrust, String mailUsername, String mailPwd, String mailForAddress,String generatedPwd, String userName, String internalConverterUri) throws MessagingException {
        logger.info("EmailServiceImplUser - sendEmail execution started");
        ...
        message.setRecipients(
                Message.RecipientType.TO, InternetAddress.parse(mailForAddress));
        message.setSubject(Globals.MAIL_SUBJECT_MESSAGE);

        String msg = Globals.MAIL_BODY_MESSAGE.replace("#",userName).replace("*", generatedPwd).replace("$",internalConverterUri);
